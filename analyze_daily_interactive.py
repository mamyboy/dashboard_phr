...
<style>
  ...
  *{box-sizing:border-box}
  ...
  @media(max-width:680px){
    ...
    .chartjs-box.chart-horizontal{overflow-x:auto;overscroll-behavior-inline:contain;padding-bottom:6px;-webkit-overflow-scrolling:touch}.chartjs-box.chart-horizontal .chart-stage{width:640px;min-width:640px}
